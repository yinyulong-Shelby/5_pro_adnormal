function RadarChart(id, data, options) {
	...
	var minValue = Math.min(cfg.maxValue, d3.min(data, function(i){return d3.min(i.map(function(o){return o.value;}))}));
	...
	axisGrid.selectAll(".axisLabel")
	   ...
	   .attr("fill", "black")
	   .text(function(d,i) { return (minValue+(d*(maxValue-minValue)/cfg.levels)).toFixed(4); });
	...
	blobCircleWrapper.selectAll(".radarInvisibleCircle")
		...
		.on("mouseover", function(d,i) {
			...
			return tooltip.style('visibility', 'visible').text("O " + ELIST[IDLIST[d['id']]] + '\n' + d['value'].toFixed(4)) 
		})
